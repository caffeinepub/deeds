...
export default function Gate() {
  ...
  return (
    <div className="container py-8 pb-24 max-w-7xl mx-auto relative z-10">
      <div className="text-center mb-12 space-y-8 tech-card p-10 md:p-12">
        ...
        {searchQuery && (
          <Card className="max-w-2xl mx-auto tech-card mt-6">
            <CardHeader>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-12">
        <Card className="tech-card cursor-pointer group">
          <CardContent className="pt-8 text-center space-y-4">
            <div className="icon-container w-20 h-20 mx-auto group-hover:scale-110 transition-transform">
              <Video className="h-10 w-10 text-primary" strokeWidth={2} />
            </div>
        ...
        <Card className="tech-card cursor-pointer group">
          <CardContent className="pt-8 text-center space-y-4">
            <div className="icon-container w-20 h-20 mx-auto group-hover:scale-110 transition-transform">
              <MessageSquare className="h-10 w-10 text-primary" strokeWidth={2} />
            </div>
        ...
        <Card className="tech-card cursor-pointer group">
          <CardContent className="pt-8 text-center space-y-4">
            <div className="icon-container w-20 h-20 mx-auto group-hover:scale-110 transition-transform">
              <Users className="h-10 w-10 text-primary" strokeWidth={2} />
            </div>
      ...
      <div className="mb-12">
        <div className="tech-card p-8 md:p-10">
          <div className="flex items-center gap-3 mb-8">
            <Sparkles className="h-8 w-8 text-primary animate-pulse-glow" strokeWidth={2} />
      ...
      <div className="space-y-8">
        <div className="flex items-center justify-between tech-card p-6">
          ...
          <Card className="tech-card">
            <CardContent className="py-16 text-center space-y-4">
              <SafeImageIcon
                ...
                fallbackIcon={<TrendingUp className="h-16 w-16 mx-auto opacity-50 text-primary" strokeWidth={2} />}
              />
